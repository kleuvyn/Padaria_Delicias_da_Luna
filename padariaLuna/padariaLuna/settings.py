"""
Django settings for padariaLuna project.
...
SECRET_KEY = 'django-insecure-e6==_t9_$sy&5s!n9w_2(09-94(@h%_-p1-l@uyig-+q#^bx&('
...
WSGI_APPLICATION = 'padariaLuna.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app1/staticfiles')
]
